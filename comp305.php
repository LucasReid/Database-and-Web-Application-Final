...
$SQL = "Insert into Members( FoS_id, Member_name, Grad_Year, Email, Password) values (";
//$SQL .= "\"".$_POST['Member_id']."\"";
...
$SQL .= ");";
		...
		if ( $Results )
		{
		    ...
		    $_SESSION['Member_id']=$Connection->insert_id;
...
function WriteRegistrationINFO($fos)
{
    ...
    $SQL = "select * from Members where FoS_id = '$fos';";
    ...
    if ( $Results )
    {
        ...
        //might need to add password here.
